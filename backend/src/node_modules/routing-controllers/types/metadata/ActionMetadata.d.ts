...
import { ControllerMetadata } from 'routing-controllers/types/metadata/ControllerMetadata';
import { InterceptorMetadata } from 'routing-controllers/types/metadata/InterceptorMetadata';
import { ParamMetadata } from 'routing-controllers/types/metadata/ParamMetadata';
import { ResponseHandlerMetadata } from 'routing-controllers/types/metadata/ResponseHandleMetadata';
import { HandlerOptions } from 'routing-controllers/types/decorator-options/HandlerOptions';
import { RoutingControllersOptions } from 'routing-controllers/types/RoutingControllersOptions';
import { UseMetadata } from 'routing-controllers/types/metadata/UseMetadata';
/**
 * Action metadata.
 */
